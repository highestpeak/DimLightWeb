...
function newRSSSource(formDataArgs, bvToastInstance = null) {
  // formDataSend = {
  //   // not blank
  //   url: "http://iamsujie.com/feed/",
  //   // not blank
  //   titleUser: randomString(4),
  //   // not blank
  //   generator: "random",
  //   // TEXT:text len less than 4
  //   // URL:image legal url
  //   // BOOTSTRAP
  //   // FONTAWESOME
  //   image: "TEXT:Bili",
  //   descUser: randomString(64),
  //   tags: ['random', 'video'],
  //   topics: ['知乎'],
  //   jsonOptionalExtraFields: JSON.stringify({ x: 5, y: 6 }),
  //   createTask: true,
  //   // taskParams: null,
  //   // 这里启动的就是 simple task
  //   taskParams: {
  ...
  //     cacheCycle: 3600,
  //     autoDownload: false,
  //     nextEventSet: "2021-02-24 12:20:20",
  //   },
  // }
...
function updateRSSSource(formDataArgs, succeedCallback = null) {
  ...
  axios.put('/api/rss/source/', formDataSend)
    ...
    .then(function (response) {
      if (succeedCallback !== null) {
        succeedCallback("update success");
      }
    })
    .catch(function (error) {
